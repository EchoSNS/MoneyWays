...
?>
	...
	<section class="bg-title-page" style="background-color: #CCCCCC;background-image: url(images/cover_img/background-no-mountains-bottom.jpg);">
		<div class="sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
			...
			<h2 class="xl-text3 t-center m-b-37">
				Buy Scraps From Different Users, Shops, Company, and Manufacturers
			</h2>

			<div class="w-size1">
				<!-- Button -->
				<a href="#shopnow" class="flex-c-m size2 bo-rad-23 s-text2 bgwhite hov1 trans-0-4">
					Shop Now
				</a>
			</div>
		</div>
	...
	<!-- Content page -->
	<section id = "shopnow" class="bgwhite p-t-55 p-b-65">
		<div class="container">
			<div class="row">
					...
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<div class="search-product pos-relative bo4 of-hidden">
							<form method="post"accept-charset="UTF-8">
								...
								<button name="submit" type="submit" class="flex-c-m size5 ab-r-m color2 color0-hov trans-0-4">
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<div class="row">
						...
						<?php 
						if($_GET['category'] > 0){
							$product->getSpecificProductCategory($_GET['category']);
						}
						else if(isset($_POST["submit"])){
							$product->searchByNameProduct($searchProduct);
						}
						else{
							$product->listProduct();
						}
			...
			<div class="row">
				...
				<div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
					...
					<div class="block3">
						...
						<div class="block3-txt p-t-14 t-center">
							<h4 class="p-b-7 m-text11">
								Verified Company/Manufacturer Seller
							</h4>
